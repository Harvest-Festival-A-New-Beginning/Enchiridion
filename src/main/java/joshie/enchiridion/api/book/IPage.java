...
public interface IPage {
    ...
    void addFeature(joshie.enchiridion.data.book.FeatureProvider feature, int x, int y, double width, double height, boolean isLocked, boolean isHidden, boolean isFromTemplate);
